...
forgetflag = True # Allows model to simuulate the process of
                  # forgetting the new associatiation that it learned
                  # if pulsed is not felt for awhile, forget that
                  # it has recently been safe to feel the pusle
